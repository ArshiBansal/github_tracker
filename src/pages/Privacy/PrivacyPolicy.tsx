        ...
        <div className="mb-14 pb-8 border-b border-zinc-200/80 dark:border-zinc-800/80 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-400 dark:text-zinc-500">
              Comprehensive disclosure regarding data scopes, OAuth lifecycle
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  ...
                  requests using official GitHub REST and GraphQL v4 API
                  structures. When authorizing our application, the platform
                  requests specific parameters categorized into distinct
                  ...
                  <div className="p-4 rounded-xl border border-zinc-200/60 dark:border-zinc-800/80 bg-white/40 dark:bg-zinc-900/30 flex items-start gap-3 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 mt-0.5 leading-relaxed">
                        Unique GitHub account numbers, alphanumeric handles,
                        public email registries, display names, avatar image
                        URLs, and explicit organizational memberships.
                      </p>
                    </div>
                  </div>
                  <div className="p-4 rounded-xl border border-zinc-200/60 dark:border-zinc-800/80 bg-white/40 dark:bg-zinc-900/30 flex items-start gap-3 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 mt-0.5 leading-relaxed">
                        Repository naming schemes, fork/star status parameters,
                        pull request records, timeline branches, file alteration
                        schemas, and lines of code changed.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section className="group relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  Your tracking details are captured strictly to fulfill runtime
                  chart mappings, contribution breakdowns, and metric
                  visualizations within your dashboard component stack. We
                  operate on a strict data minimization protocol:
                </p>
                <div className="p-4 rounded-xl border border-dashed border-zinc-300 dark:border-zinc-800 bg-white/30 dark:bg-zinc-900/20 text-sm italic text-zinc-500 dark:text-zinc-400">
                  "No raw underlying source code contents, software structural
                  logic matrices, or code blobs are ever read, indexed, parsed,
                  or transferred beyond your current transient client session
                  execution."
                </div>
              </div>
            </div>
          ...
          <section className="group relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  Authentication OAuth variables are kept isolated inside
                  client-side cross-site safe state blocks or managed through
                  backend encryption protocols using advanced environment keys.
                  Tokens hold restricted, read-only permissions mapping strictly
                  to the interfaces you use.
                </p>
                <div className="p-4 rounded-xl bg-zinc-100/60 dark:bg-zinc-900/60 border border-zinc-200/50 dark:border-zinc-800 text-sm flex items-start gap-3">
                  ...
                  <p className="text-xs md:text-sm leading-6">
                    <strong>Total Sovereignty:</strong> You can break
                    application scope permissions instantly at any point. Simply
                    head over to your personal GitHub settings page under{" "}
                    <code className="px-1.5 py-0.5 bg-white dark:bg-zinc-800 text-rose-500 dark:text-rose-400 font-mono text-xs rounded border border-zinc-200 dark:border-zinc-700">
                      Settings &rarr; Authorized OAuth Apps
                    </code>{" "}
                    and execute "Revoke Access".
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="group relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  We match our data lifecycles with the minimal window needed to
                  calculate tracker outputs. Transient API query results are
                  kept inside system short-term cache loops to prevent hitting
                  rate limits against GitHub's infrastructure.
                </p>
                <p className="text-sm leading-6 text-zinc-500 dark:text-zinc-400">
                  If you manually unbind your profile or close your application
                  tracking dashboard, all temporary caches connected with your
                  profile identity scope are dropped automatically within 24
                  hours.
                </p>
              </div>
            </div>
          ...
          <section className="group relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  We do not lease or exchange analytical summaries with
                  commercial ad engines. To deliver this platform service
                  safely, operations traverse specific cloud infrastructure
                  subprocessors:
                </p>
                <ul className="list-disc list-inside space-y-2 text-sm text-zinc-500 dark:text-zinc-400 pl-2">
                  <li>
                    ...
                    Primary provider of identity verification mechanisms and the
                    source repository API layer.
                  </li>
                  <li>
                    <strong className="text-zinc-700 dark:text-zinc-300">
                      Cloud Web Hosting (e.g., Vercel/Render):
                    </strong>{" "}
                    Delivers static code distribution structures and secure
                    frontend client runtime routing instances.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  ...
                  cookie scripts designed to catalog off-site interactions. We
                  utilize standard browser{" "}
                  <code className="px-1.5 py-0.5 bg-white dark:bg-zinc-800 text-amber-500 font-mono text-xs rounded border border-zinc-200 dark:border-zinc-700">
                    LocalStorage
                  </code>{" "}
                  and state variables strictly to preserve state parameters:
                </p>
                <ul className="list-disc list-inside space-y-1.5 text-xs md:text-sm pl-2">
                  <li>
                    Theme state configurations (Syncing dark/light toggles
                    securely).
                  </li>
                  <li>
                    Active session routing indices (Preventing drop-offs when
                    running complex repository lookups).
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="group relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  Our telemetry tools are structured for developers, open-source
                  engineers, and software project maintainers. We do not
                  intentionally harvest account vectors or profile tracking
                  traces from users under the age of 13. If any minor submits
                  profile identifiers, we will purge those traces from
                  short-term memory setups immediately upon notification.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="group relative">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3 w-full">
                ...
                <p className="text-sm md:text-base leading-7 text-zinc-600 dark:text-zinc-400">
                  Under strict modern global privacy framework mandates
                  (including GDPR and CCPA standardizations), you retain
                  unconditional control over your data metrics. For explicit
                  token cache flush requests, structural transparency audits, or
                  operational logging inquiries, you are invited to launch an
                  official issue ticket inside our repository project workspace.
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="mt-16 p-6 rounded-2xl bg-gradient-to-r from-zinc-100 to-zinc-50 dark:from-zinc-900/50 dark:to-zinc-900/30 border border-zinc-200/80 dark:border-zinc-800/80 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 shadow-sm">
          <div className="space-y-1">
            ...
            <p className="text-xs md:text-sm text-zinc-400 dark:text-zinc-500">
              Our active community engineers are standing by to review
              repository processing flows.
            </p>
          </div>
          <a
            href="/contact"
